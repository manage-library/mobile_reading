      ...
      child: Column(
        children: [
          Align(
            ...
            child: Text("Bạn có chắc chắn muốn đăng xuất?",
          ...
          TextButton(
            ...
            child:
                Text("Đồng ý", style: AppStyles.styleTextTitleMethod.copyWith(color: AppColors.colorTextTitleMethod)),
          ),
          const SizedBox(
            height: 16,
          ),
          TextButton(
            style: ButtonStyle(
                ...
                minimumSize: MaterialStateProperty.all(Size(Get.width - 40, 54))),
            onPressed: () => Get.back(),
            child: Text("Hủy", style: AppStyles.styleTextTitleMethod.copyWith(color: AppColors.colorDepositIcon)),
          ),
        ],
      ),
    );
